...
interface EditRealEstatePDFProps {
  clientId: string;
}

// Create Document Component
const EditRealEstatePDF: FC<EditRealEstatePDFProps> = (props) => {
              ...
              <View>
                <View style={styles.section}>
                  <Text style={styles.title}>
                    Заявление об изменение характеристик недвижимости
                  </Text>
                </View>
...
export default EditRealEstatePDF;
